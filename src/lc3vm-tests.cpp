...
/**
 * @brief Lc3vm_Task 1: Test memory access functions to read and write into
 *   the simulated 64k 16-bit addressable memory of the LC-3
 */
TEST_CASE("Lc3vm_Task 1: memory access functions", "[lc3vm_task1]")
{
  // the lc3vm is persistent simple c program, so we can no longer
  // assume that no tests run before this, so initialize all of memory
  // to 0 in preparation for tests in this file
...
/**
 * @brief Lc3vm_Task 2: Test sign extension function
 */
TEST_CASE("Lc3vm_Task 2: sign_extend function implementation", "[lc3vm_task2]")
{
...
// some example instructions to test, used in lc3vm_task 3 tests
...
/**
 * @brief Lc3vm_Task 3: Test instruction extraction macros
 */
TEST_CASE("Lc3vm_Task 3: OPC instruction extraction operations", "[lc3vm_task3]")
{
...
TEST_CASE("Lc3vm_Task 3: SR2 source register 2 extraction operations", "[lc3vm_task3]")
{
  CHECK(SR2(and_ins) == 0x5);
  CHECK(SR2(add2_ins) == 0x3);
}

TEST_CASE("Lc3vm_Task 3: SR1 source register 1 extraction operations", "[lc3vm_task3]")
{
...
TEST_CASE("Lc3vm_Task 3: DR destination register extraction operations", "[lc3vm_task3]")
{
 ...
 */
TEST_CASE("Lc3vm_Task 4: condition code flags update function", "[lc3vm_task4]")
{
  // Test only 0 is set
  reg[R1] = 0x0000;
  update_flags(R1);
...
/**
 * @brief Lc3vm_Task 5: Implement LC-3 arithmetic / logic Microcode Operations
 */
TEST_CASE("Lc3vm_Task 5: implement add arithmetic / logic operator", "[lc3vm_task5]")
{
...
TEST_CASE("Lc3vm_Task 5: implement andlc arithmetic / logic operator", "[lc3vm_task5]")
{
  // test two source register mode
  reg[R1] = 0xF1F1;
  reg[R2] = 0xAFAF;
...
TEST_CASE("Lc3vm_Task 5: implement notlc  arithmetic / logic operator", "[lc3vm_task5]")
{
...
/**
 * @brief Lc3vm_Task 6: Implement load memory access operators
 */
TEST_CASE("Lc3vm_Task 6: ld implement load memory access operators", "[lc3vm_task6]")
{
...
TEST_CASE("Lc3vm_Task 6: ldi implement load memory access operators", "[lc3vm_task6]")
{
  // put some values into memory and set RPC to 0x3000 for tests of load operators
  reg[RPC] = PC_START;
  mem[PC_START] = 0x1234;
...
TEST_CASE("Lc3vm_Task 6: ldr implement load memory access operators", "[lc3vm_task6]")
{
...
TEST_CASE("Lc3vm_Task 6: lea implement load memory access operators", "[lc3vm_task6]")
{
...
/**
 * @brief Lc3vm_Task 7: Implement store memory access operators
 */
TEST_CASE("Lc3vm_Task 7: st implement store memory access operators", "[lc3vm_task7]")
{
...
TEST_CASE("Lc3vm_Task 7: sti implement store memory access operators", "[lc3vm_task7]")
{
...
TEST_CASE("Lc3vm_Task 7: str implement store memory access operators", "[lc3vm_task7]")
{
...
/**
 * @brief Lc3vm_Task 8: Implement control flow operators
 */
TEST_CASE("Lc3vm_Task 8: jmp implement control flow operators", "[lc3vm_task8]")
{
...
TEST_CASE("Lc3vm_Task 8: br implement control flow operators", "[lc3vm_task8]")
{
...
TEST_CASE("Lc3vm_Task 8: jsr / jsrr implement control flow operators", "[lc3vm_task8]")
{
